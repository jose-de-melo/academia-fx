package br.com.academia.arquivos;
...
public class ArquivoTexto {
	 ...
	 */
	   ...
	   * só para escrita. A leitura não é permitida.
	   * 
	   ...
	   * 
	   * @return um <code>ArrayList <{@link String}></code> com o conteúdo lido do arquivo texto.
	   *
	   * @throws IllegalStateException ocorre se o arquivo estiver fechado.  
	   */
	  public ArrayList<String> ler() throws IllegalStateException {
